...
use Tests\Browser\Components\UpdateEvents;

class UpdateDuskPage extends Page
{
    ...
    protected array $selectorsAliases = [
        ...
        '@updateSubmitBtn' => '.update-submit-btn',
    ];
    ...
    {
        return route('user-edit-form', ['user' => $this->user->id]);
    }
    ...
    public function assert(Browser $browser): void
    {
        ...
        $browser->assertRouteIs('user-edit-form', ['user' => $this->user->id]);
    }
    ...
    public function confirmVisibleInputFieldsCanReceiveSubmitAndRedirectAfterEnteredData(Browser $browser, string $submitBtnSelector, string $redirectOrReloadRoute): void
    {
        ...
        $browser->press($submitBtnSelector)
            ...
            ->within(new UpdateEvents, function ($browser) {
                $browser->displayUpdateSuccessMessage();
            })
